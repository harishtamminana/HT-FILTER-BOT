...
# Bot information
SESSION = environ.get('SESSION', 'HT FILEZ Bot')
API_ID = int(environ.get('API_ID', '30127563'))
API_HASH = environ.get('API_HASH', '7d125eb6898042d88a79e6912527b9e7')
BOT_TOKEN = environ.get('BOT_TOKEN', "8054178410:AAHv3mLuBLyK7MjWBSx_osnz0Q2bs_Pz4VE")
...
# Admins & Users
ADMINS = [int(admin) if id_pattern.search(admin) else admin for admin in environ.get('ADMINS', '8139675950').split()] # For Multiple Id Use One Space Between Each.
auth_users = [int(user) if id_pattern.search(user) else user for user in environ.get('AUTH_USERS', '8139675950').split()]  # For Multiple Id Use One Space Between Each.
AUTH_USERS = (auth_users + ADMINS) if auth_users else []

# This Channel Is For When User Start Your Bot Then Bot Send That User Name And Id In This Log Channel, Same For Group Also.
LOG_CHANNEL = int(environ.get('LOG_CHANNEL', '-1003670650030'))

# This Is File Channel Where You Upload Your File Then Bot Automatically Save It In Database 
CHANNELS = [int(ch) if id_pattern.search(ch) else ch for ch in environ.get('CHANNELS', '-1003670650030 -1003509274369').split()]  # For Multiple Id Use One Space Between Each.
...
auth_channel = environ.get('AUTH_CHANNEL', 'HT FILEZ GROUP') # give your force subscribe channel id here else leave it blank
AUTH_CHANNEL = int(auth_channel) if auth_channel and id_pattern.search(auth_channel) else None

# This Channel Is For When User Request Any File Name With command or hashtag like - /request or #request
reqst_channel = environ.get('REQST_CHANNEL', 'REQUEST HT FILEZ')
...
support_chat_id = environ.get('SUPPORT_CHAT_ID', '8139675950')
...
# MongoDB information
DATABASE_URI = environ.get('DATABASE_URI', "mongodb+srv://harishtamminana_db_user:<db_password>@cluster0.hy8rfow.mongodb.net/?appName=Cluster0?tls=true&tlsAllowInvalidCertificates=true")   # IF Multiple Database Is False Then Fill Only This Database Url.
DATABASE_NAME = environ.get('DATABASE_NAME', "HTFILEZGROUP")
COLLECTION_NAME = environ.get('COLLECTION_NAME', 'HT FILEZ GROUP')
...
# Links
GRP_LNK = environ.get('GRP_LNK', 'https://t.me/+M0MIw8az-_cwNmU9')
CHNL_LNK = environ.get('CHNL_LNK', 'https://t.me/+AQ93IV1Awvo2N2U9')
SUPPORT_CHAT = environ.get('SUPPORT_CHAT', '') # Support Chat Link Without https:// or @
OWNER_LNK = environ.get('OWNER_LNK', '@Harishthalaiva12')
